    ...
    <form onSubmit={formSubmit(handleSubmit)}>
      <Stack>
        <FormControl isRequired isInvalid={errors.title}>
          <HStack>
            <FormLabel m={0} htmlFor='title'>Title</FormLabel>
        ...
        <FormControl isRequired isInvalid={errors.body}>
          <HStack>
            <FormLabel m={0} htmlFor='body'>Body</FormLabel>
            { dirtyFields.body && <ErrorTag error={errors.body} /> }
          </HStack>
          <Textarea isRequired id='body' placeholder="Body" noOfLines={40} {...register("body", {
            required: 'Required',
