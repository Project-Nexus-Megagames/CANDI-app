      ...
      <React.Fragment>
        <Modal.Header>
          <Modal.Title>
            ...
            <span style={{marginLeft:'10px', display: 'inline', verticalAlign:'super'}}>{article.headline}</span>
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <p><b>Author:</b> Some Bloke | <b>Publisher:</b> {article.publisher.characterName}</p>
          <p>location here - 00000</p>
          <Divider />
          <p>{article.body}</p>
