...
import { Progress, Loader, Panel, Icon, IconStack, Row, Col, Alert, Button } from 'rsuite';
		...
		history.push('/home');
			...
			return (
				<div style={{ justifyContent: 'center', textAlign: 'center', width: '100%' }}>
					...
					<Button onClick={()=> { props.logOut(); history.push('/login'); }}>Log Out</Button>
...
const gamePhotos = [
	'https://acegif.com/wp-content/gifs/pirate-flag-1.gif'
];
