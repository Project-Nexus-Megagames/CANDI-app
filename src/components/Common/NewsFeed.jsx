...
import { InputGroup, Whisper, Popover, Input, Icon, IconButton, TagPicker } from 'rsuite';
...
const NewsFeed = (props) => {
	...
	// if (data.length === 0) return <p>Nothing to show here, move along!</p>;

	return (
		<Center maxW="960px" mx="auto">
			<Box bg="bg-surface" py="4">
				<Stack divider={<StackDivider />} spacing="4">
					<Input style={{ width: '80%' }} align="center" onChange={(e) => handleSearch(e)} placeholder="Search"></Input>
					{data
						.filter((article) => article.title.toLowerCase().includes(searchQuery))
						.map((item) => (
