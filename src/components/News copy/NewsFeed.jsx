	...
	return (
		<Container>
				...
				<FlexboxGrid justify="center" align="middle">
					<FlexboxGrid.Item colspan={4}>
						<InputGroup>
							...
							<Button style={{ color: 'black', borderRadius: '0px' }} color="green" onClick={() => handleThis()}>
								<Icon icon="plus" />
							</Button>
							...
							{show === 'filter' && <TagPicker style={{ borderRadius: '0px' }} menuStyle={{}} defaultExpandAll data={tags} defaultValue={tags} placeholder="Set Filters" valueKey="value" onChange={(tags) => setTags(tags)} />}
						</InputGroup>
					</FlexboxGrid.Item>
				</FlexboxGrid>
			</Header>
			...
			<Content>
				...
				{props.articles.length > 0 ? <div></div> : null}
			</Content>
