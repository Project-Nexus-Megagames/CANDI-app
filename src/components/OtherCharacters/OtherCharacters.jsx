		...
		return (
			<React.Fragment>
				...
				<Container style={{ height: 'calc(100vh - 50px)' }}>
					...
					<ViewCharacter control={props.myCharacter.tags.some((el) => el === 'Control')} assets={props.assets} isOpen={selected} show={selected} selected={selected} closeDrawer={() => setSelected(false)} />								
				</Container>
