...
import { FlexboxGrid, Avatar, Tag } from 'rsuite';
...
const CharacterListItem = (props) => {
	...
	return (
		<div onClick={() => setSelected(character)} style={listStyle(character)}>
			<FlexboxGrid align="middle">
				<FlexboxGrid.Item colspan={5}>
					<Avatar src={character.profilePicture} alt="?" circle />
				</FlexboxGrid.Item>
				<FlexboxGrid.Item
					colspan={19}
					style={{
				...
				>
					...
					<b style={slimText}>
						{character.email} {'  '}
						{character.tags && character.tags.map((item, index) => tagStyle(item, index))}
					</b>
				</FlexboxGrid.Item>
			</FlexboxGrid>
		</div>
