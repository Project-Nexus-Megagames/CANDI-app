					...
					<div style={{	border: '3px solid #531ba8', borderRadius: '5px' }}>
						<FlexboxGrid  style={infoComm} align='middle' justify="start">
							<FlexboxGrid.Item style={{ margin: '5px' }} colspan={4}>
									<Avatar circle size="md" src={`/images/${this.props.effect.effector}.jpg`} alt="?" style={{ maxHeight: '50vh' }} />
							</FlexboxGrid.Item>
					...
					onHide={() => this.setState({ effectEdit: false })}>
						...
						<br></br>
							<form>
								...
								<textarea rows='6' defaultValue={this.props.effect.description} value={this.state.description} style={textStyle} onChange={(event)=> this.setState({description: event.target.value})}></textarea>	
							</form>
						</Modal.Body>
						<Modal.Footer>
