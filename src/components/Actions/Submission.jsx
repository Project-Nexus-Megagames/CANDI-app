            ...
            >
                ...
                >
                    ...
                    <FlexboxGrid.Item colspan={15}>
                        ...
                        {props.myCharacter.tags.some((el) => el === 'Control') && props.action.tags.length === 0 &&
                            <b>No Tags</b>}
                        {props.myCharacter.tags.some((el) => el === 'Control') &&
                ...
                >
                    ...
                    {submission.effort.effortType !== 'Agenda' && (
                        <div>
                            ...
                            >{submission.effort.amount}</p>
                            <Progress.Line
                                percent={submission.effort.amount * 50}
                                showInfo={false}
                            ></Progress.Line>
                        </div>
                    )}
                ...
                >
                    ...
                    <Modal.Body style={{
                        border: `4px solid ${getFadedColor(props.action.type)}`,
                        borderRadius: '5px',
                        padding: '15px'
                    }}
                    >
